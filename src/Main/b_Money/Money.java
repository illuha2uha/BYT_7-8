...
public class Money implements Comparable {
	...
	public Integer universalValue() {
		return this.currency.universalValue(amount/100);
	}
	...
	public Money add(Money other) {
		int addedAmount = this.amount + other.currency.valueInThisCurrency(other.amount, this.currency);
	...
	public Money sub(Money other) {
		int subAmount = this.amount - other.currency.valueInThisCurrency(other.amount, this.currency);
